...
public class demo {
	...
	public demo(String hospitalName, List<String> listOfTreatments, String contactPerson, String contactNumber,
			String location) {
		super();
	...
	public String toString() {
		return "demo1 [hospitalCode=" + hospitalCode + ", hospitalName=" + hospitalName + ", listOfTreatments="
